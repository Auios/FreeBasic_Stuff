...
var sHost = "25.37.119.230" '"mysoft.zapto.org" 'At the start of the program, I can call for a custom IP Using sHost? yes
...
var iResu = hConnect(MySocket,MyIP,12345) 'socket/ip/port
