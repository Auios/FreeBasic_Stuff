...
#define BLSCAN(target, pattern, mask)            \
	target = (target##Fn)ScanFunc((char*)pattern, (char*)mask); \
	if(target == NULL)                             \
...
FnExport void ConsoleFunctionString(const char* scope, const char* name, StringCallback callBack, const char* usage, int minArgs, int maxArgs);
FnExport void ConsoleFunctionInt(const char* scope, const char* name,    IntCallback callBack, const char* usage, int minArgs, int maxArgs);
FnExport void ConsoleFunctionFloat(const char* scope, const char* name,  FloatCallback callBack, const char* usage, int minArgs, int maxArgs);
FnExport void ConsoleFunctionVoid(const char* scope, const char* name,   VoidCallback callBack, const char* usage, int minArgs, int maxArgs);
FnExport void ConsoleFunctionBool(const char* scope, const char* name,   BoolCallback callBack, const char* usage, int minArgs, int maxArgs);

FnExport void ConsoleVariableInt(const char *name, int *data);
FnExport void ConsoleVariableBool(const char *name, bool *data);
FnExport void ConsoleVariableFloat(const char *name, float *data);
FnExport void ConsoleVariableChar(const char *name, char *data);

//Evaluate a torquescript string in global scope
FnExport const char* Eval(const char* str);
