...
declare function hResolve       ( hostname as zstring ptr ) as integer 
...
'declare function hBind          ( byval s as SOCKET, byval port as integer, iIP as integer = INADDR_ANY ) as integer
